...
RSpec.describe 'Hotels API', type: :request do
  before :each do
    ...
    @reservation = Reservation.create!({ user_id: @user1.id, hotel_id: @hotel1.id, city: 'New York',
                                         date: '2022-08-02' })
  end
  ...
  describe 'Post api/v1/reservations#create' do
    before(:example) do
      post api_v1_user_hotel_reservations_path(@user1, @hotel2),
           params: { reservation: { city: 'London', date: '2022-09-12' } }
    end
